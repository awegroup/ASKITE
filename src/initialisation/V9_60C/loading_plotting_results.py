...
from functions_plotting import get_3D_plot_N_D,get_3D_plot_N_D_4times,get_3D_plot_N_D_4times_PLUS_lines,get_3D_plot_N_D_6times_PLUS_2lines
...
get_3D_plot_N_D_6times_PLUS_2lines(plot_strut_particles_bridle,plot_strut_LE,plot_mid_tip_LE,plot_strut_particles,plot_bridle_points,plot_pulleys,plot_line_varibles_wing,plot_line_varibles_bridle)
...
rib_strut_canopy            = np.load('results/'+name_file+'_rib_strut_canopy.npy',allow_pickle=True )
...
plot_mid_tip_LE             = np.load('results/'+name_file+'_plot_mid_tip_LE.npy',allow_pickle=True )
vertices_wing               = np.load('results/'+name_file+'_vertices_wing.npy' )
pulley_idx_list             = np.load('results/'+name_file+'_pulley_idx_list.npy' )
supervector_bridles_pulleys = np.load('results/'+name_file+'_supervector_bridles_pulleys.npy',allow_pickle=True )
