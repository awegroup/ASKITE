...
import sys
from src.initialisation.V9_60C.functions_plotting import *
...
filepath_open = '/home/jellepoland/surfdrive/phd/code/phd_Jelle_Poland/Simulations/src/initialisation/V9_60C/results/'
filepath_save = '/home/jellepoland/surfdrive/phd/code/phd_Jelle_Poland/Simulations/src/initialisation/V9_60C/results_bridle_only/'


## points
# wing
points_ini_model                            =np.load(filepath_open+'points_ini_model.npy',allow_pickle=True)
points_ini_model_wing                       =np.load(filepath_open+'points_ini_model_wing.npy',allow_pickle=True) 
points_ini_model_wing_vertices              =np.load(filepath_open+'points_ini_model_wing_vertices.npy',allow_pickle=True)
points_ini_model_LE_per_strut               =np.load(filepath_open+'points_ini_model_LE_per_strut.npy',allow_pickle=True)
points_ini_model_LE_per_mid_tip             =np.load(filepath_open+'points_ini_model_LE_per_mid_tip.npy',allow_pickle=True)
points_ini_model_canopy_per_strut           =np.load(filepath_open+'points_ini_model_canopy_per_strut.npy',allow_pickle=True)
points_ini_model_TE_per_strut               =np.load(filepath_open+'points_ini_model_TE_per_strut.npy',allow_pickle=True)
points_ini_model_bridle_attachment_points   =np.load(filepath_open+'points_ini_model_bridle_attachment_points.npy',allow_pickle=True)

# bridles
points_ini_model_bridle_vertices    =np.load(filepath_open+'points_ini_model_bridle_vertices.npy',allow_pickle=True)
points_ini_model_bridle             =np.load(filepath_open+'points_ini_model_bridle.npy',allow_pickle=True)
points_ini_model_pulleys            =np.load(filepath_open+'points_ini_model_pulleys.npy',allow_pickle=True)
pulley_point_indices                =np.load(filepath_open+'pulley_point_indices.npy',allow_pickle=True)

# rib_db_whole
rib_db_whole_model  = np.load(filepath_open+'rib_db_whole_model.npy',allow_pickle=True)

## connectivity
ci_bridle_indexed_on_bridle     =np.load(filepath_open+'ci_bridle_indexed_on_bridle.npy',allow_pickle=True)
cj_bridle_indexed_on_bridle     =np.load(filepath_open+'cj_bridle_indexed_on_bridle.npy',allow_pickle=True)
ci_wing                         =np.load(filepath_open+'ci_wing.npy',allow_pickle=True)
cj_wing                         =np.load(filepath_open+'cj_wing.npy',allow_pickle=True)
ci_bridle                       =np.load(filepath_open+'ci_bridle.npy',allow_pickle=True)
cj_bridle                       =np.load(filepath_open+'cj_bridle.npy',allow_pickle=True)
...
# tubular frame
np.save(filepath_save+'conn_tubular_frame_i.npy',conn_tubular_frame_i )
np.save(filepath_save+'conn_tubular_frame_j.npy',conn_tubular_frame_j )
np.save(filepath_save+'tube_point_indices.npy',tube_point_indices )
np.save(filepath_save+'tube_line_indices.npy',tube_line_indices)

# canopy
np.save(filepath_save+'conn_canopy_i.npy',conn_canopy_i )
np.save(filepath_save+'conn_canopy_j.npy',conn_canopy_j )

# wing
np.save(filepath_save+'conn_wing_i.npy',conn_wing_i )
np.save(filepath_save+'conn_wing_j.npy',conn_wing_j )
np.save(filepath_save+'plate_point_indices.npy',plate_point_indices )

### saving the newly found points 
np.save(filepath_save+'rib_db_whole_model_struts.npy',rib_db_whole_model_struts ) #list with only the struts
np.save(filepath_save+'points_ini_model_bridle.npy',points_bridle )

## saving old stuff, in the new folder
np.save(filepath_save+'bridle_ci.npy',bridle_ci )
np.save(filepath_save+'bridle_cj.npy',bridle_cj ) 

## Bridle line system
np.save(filepath_save+'pulley_point_indices.npy',pulley_point_indices)
np.save(filepath_save+'bridlepoint_index.npy',bridlepoint_index)

# KCU THINGS
np.save(filepath_save+'kcu_point_indices.npy',kcu_point_indices )
np.save(filepath_save+'kcu_line_indices.npy',kcu_line_indices )
np.save(filepath_save+'kcu_plate_indices.npy',kcu_plate_indices )


# %%
print(rib_db_whole_model_struts[0][5])
# print(rib_db_whole_model_struts[1])
print(len(rib_db_whole_model_struts))