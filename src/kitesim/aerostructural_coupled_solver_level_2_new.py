...
def main(
    ...
    ### AERO --> STRUC
    f_aero_wing = aero2struc_level_2_new.main(
    ...
    aero2struc_level_2_new.check_moment_preservation(
        ...
        for i in range(max_iter):
            ...
            if config["structural_solver"] == "pss":
                ...
                kite_fem_structure, is_structural_converged, struc_nodes, f_int = (
                    structural_kite_fem_level_2_new.run_kite_fem(
            ...
            if config["is_with_struc_plot_per_iteration"]:
                if config["structural_solver"] == "pss":
                    ...
                    rest_lengths = structural_kite_fem_level_2_new.get_rest_lengths(
