...
def run_aerostructural_solver(sim_input):
    ...
    for i, step in enumerate(t_vector):
        ...
        path_saved_folder = Path(
            "/home/jellepoland/ownCloud/phd/code/kitesim/results/V3_25/2024_08_13_17h/straight/input"
        )
        ...
        save_data_to_json(to_be_saved_dict, path_saved_folder)
