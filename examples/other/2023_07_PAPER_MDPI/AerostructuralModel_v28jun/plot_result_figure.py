...
filename = '../AerostructuralModel_v'+date+'/run_results/pos_up_'+str(int(100*u_p))+'_13_True.csv'
...
filename = '../AerostructuralModel_v'+date+'/run_results/pos_up_'+str(int(100*u_p))+'_13_'+str(billowing_boolean)+'.csv'
pos = np.loadtxt(filename,delimiter = ',')
print("u_p",u_p,billowing_boolean,np.rad2deg(np.arctan(pos[5][2]/pos[5][0])))
...
## SAVING FIGURE
filename='PSM_full_particles_side'+str(100*u_p)+'.svg'
print(filename)
...
ax.plot([0,0],[0,0],[0,0],color='black',linewidth = 0.5,marker = '.',markersize = 0.1)
## SAVING FIGURE
filename='PSM_full_particles_top'+str(100*u_p)+'.svg'
print(filename)
plt.savefig(filename,bbox_inches = bbox)
...
ax.plot([0,0],[0,0],[0,0],color='black',linewidth = 0.5,marker = '.',markersize = 0.1)
## SAVING FIGURE
filename='PSM_full_particles_isometric'+str(100*u_p)+'.svg'
print(filename)
plt.savefig(filename,bbox_inches = bbox)
...
ax.plot([0,0],[0,0],[0,0],color='black',linewidth = 0.5,marker = '.',markersize = 0.1)
## SAVING FIGURE
filename='PSM_full_particles_front'+str(100*u_p)+'.svg'
print(filename)
plt.savefig(filename,bbox_inches = bbox)